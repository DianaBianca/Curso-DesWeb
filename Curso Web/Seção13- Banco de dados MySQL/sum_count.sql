...
#SUM(<coluna>) - soma de todos os valores de todos os registros de uma coluna
#COUNT(*)- quantidade de todos os registros de uma tabela

select sum(investimento) from cursos;
